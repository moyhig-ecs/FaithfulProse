...
% v3.1.0: <pending: minted by Zenodo when the GitHub release v3.1.0 is created>. VERSION DOI, pins the bytes of v3.1.0 (refitted-lens re-reads)
% (the TSD-20260826 re-acquisition). Concept DOI 21768364 is deliberately not the one cited here.
\newcommand{\REPODOI}{10.5281/zenodo.22219123}
